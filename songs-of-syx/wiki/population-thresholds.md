...
- **2026-07-06 (game-data, dev manual Ch28/Ch21/Ch18):** refinement — the 200-pop raider gate is the on/off switch, but raider *interest and strength* scale with **wealth** (money + stored resources + slaves; military equipment excluded), modified by defenses and deterrence. Buying raiders off works; killing them is permanent (no respawn, pays bounty). Crime "becomes an inevitability" past a population size; tourists arrive at a capital-size threshold. Fulfillment→population capacity is non-linear (Ch12): small fulfillment gains buy a lot of population headroom at scale.
